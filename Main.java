...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tempo insercion sort 20(Nanosegundo): "+ (endInsercionSort20-startInsercionSort20));
		System.out.println("Tempo merge sort 20(Nanosegundo): "+ (endMergeSort20-startMergeSort20));
		
		System.out.println(" ");
		
		System.out.println("Tempo insercion merge sort 20000(Nanosegundo): "+ (endInsercionSort20000-startInsercionSort20000));
		System.out.println("Tempo merge sort 20000(Nanosegundo): "+ (endMergeSort20000-startMergeSort20000));
	}
}
